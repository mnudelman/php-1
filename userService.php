...
function getUser($pdo,$userLogin) {
    ...
    try {
        ...
        echo 'ERROR:getUser():'.$e->getMessage().LINE_FEED ;
        return false ;
    }
}
...
function putUser($pdo,$userLogin,$password) {
    ...
    try {
        ...
        echo 'ERROR:'.$e->getMessage().LINE_FEED ;
        return false ;
    }
    return true ;
}
...
function getProfile($pdo,$userLogin) {
    ...
    try {
        ...
        echo 'ERROR:getProfile():' . $e->getMessage() . LINE_FEED;
        return false;
    }
    if (false === $row) {
        return false;
...
function putProfile($pdo,$userLogin,$profile) {
    ...
    try {
        ...
        echo 'ERROR:putProfile():'.$e->getMessage().LINE_FEED ;
        return false ;
    }
    return true ;
}
